      ...
      <section className="meet-david-section">
        <div className="meet-david-inner">
          <div className="meet-david-text">
            ...
            <p className="meet-david-body">His process is built on respect, collaboration, and a genuine enjoyment of the work itself. He believes the best results come when people feel supported, challenged, and free enough to play — when the rehearsal has structure, but also energy, humor, and trust.</p>
